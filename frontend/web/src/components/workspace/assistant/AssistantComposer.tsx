    ...
    <div className="p-3 rounded-3xl glass-panel-elevated border border-[var(--color-surface-glass-border)] shadow-2xl space-y-2.5">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          type="button"
          disabled
          className="w-10 h-10 rounded-2xl surface-recessed border border-[var(--color-border-subtle)] opacity-50 cursor-not-allowed flex items-center justify-center text-[var(--color-text-muted)] flex-shrink-0"
        ...
        {/* Microphone Toggle (Stub: simulate listening state) */}
        <button
          type="button"
          onClick={() =>
