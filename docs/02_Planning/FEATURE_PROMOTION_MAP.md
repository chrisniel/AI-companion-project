...
3. **Pass R11.1 Core Experience Domains:** Focused specifications authored and corrected for `tasks-reminders-alarms-and-routines.md`, `characters-personality-and-emotion.md`, `memory-and-personalization.md`, and `voice-and-audio.md` under `docs/04_Architecture/01_Domains/`. Semantic review corrections are complete, and canonical authority transfer remains pending the R11.4 human review gate.
4. **Pass R11.2 Integrations, Host Runtime & Client Domains:** R11.2 focused specifications authored for `assistant-and-conversations.md`, `multimodal-and-media.md`, and `android-companion.md` under `docs/04_Architecture/01_Domains/`, `web-current-information.md` under `docs/04_Architecture/03_Integrations/`, and `windows-host-and-notifications.md` under `docs/04_Architecture/04_Infrastructure/`. Semantic-review corrections complete, with authority transfer still pending R11.4 human review and authorization.
5. **Pass R11.3 Security, Data & Infrastructure Domains:** R11.3 focused specifications authored for `profiles-and-devices.md`, `authentication-and-secrets.md`, `tool-permissions-and-actions.md`, and `privacy-retention-and-audit.md` under `docs/04_Architecture/02_Data_and_Security/`, `health-and-wearables.md` under `docs/04_Architecture/03_Integrations/`, and `runtime-and-models.md`, `storage-and-assets.md`, `backup-recovery-and-diagnostics.md`, and `performance-and-capacity.md` under `docs/04_Architecture/04_Infrastructure/`. R11.3 authored, final semantic corrections applied, independent/human review complete, and canonical authority transfer remains pending R11.4 human review and explicit authorization.
6. **Pass R11.4 Authority Transfer & Legacy Authority Narrowing:** Explicitly human-authorized by Chris. Canonical domain authority has been formally transferred from legacy monolithic documents to the 18 focused domain specifications across `01_Domains/`, `02_Data_and_Security/`, `03_Integrations/`, and `04_Infrastructure/`. Legacy monolithic architecture documents have been safely narrowed to subordinate compatibility and technical-reference roles with unmistakable banners and supersession notices for conflicting legacy release text. Zero unique approved normative requirements were lost or dropped. Authority transfer applied; independent review pending. Passes R12 (Roadmap & release sequencing reconciliation) and R13 (Archival, global routing, and documentation map closure) remain separate future passes.
