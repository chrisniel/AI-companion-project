...
3. **Pass R11.1 Core Experience Domains:** Focused specifications authored and corrected for `tasks-reminders-alarms-and-routines.md`, `characters-personality-and-emotion.md`, `memory-and-personalization.md`, and `voice-and-audio.md` under `docs/04_Architecture/01_Domains/`. Semantic review completed during R11.1; canonical authority was subsequently transferred during R11.4 (see Note 6).
4. **Pass R11.2 Integrations, Host Runtime & Client Domains:** R11.2 focused specifications authored for `assistant-and-conversations.md`, `multimodal-and-media.md`, and `android-companion.md` under `docs/04_Architecture/01_Domains/`, `web-current-information.md` under `docs/04_Architecture/03_Integrations/`, and `windows-host-and-notifications.md` under `docs/04_Architecture/04_Infrastructure/`. Semantic review completed during R11.2; canonical authority was subsequently transferred during R11.4 (see Note 6).
5. **Pass R11.3 Security, Data & Infrastructure Domains:** R11.3 focused specifications authored for `profiles-and-devices.md`, `authentication-and-secrets.md`, `tool-permissions-and-actions.md`, and `privacy-retention-and-audit.md` under `docs/04_Architecture/02_Data_and_Security/`, `health-and-wearables.md` under `docs/04_Architecture/03_Integrations/`, and `runtime-and-models.md`, `storage-and-assets.md`, `backup-recovery-and-diagnostics.md`, and `performance-and-capacity.md` under `docs/04_Architecture/04_Infrastructure/`. Semantic review completed during R11.3; canonical authority was subsequently transferred during R11.4 (see Note 6).
6. **Pass R11.4 Authority Transfer & Legacy Authority Narrowing:** Explicitly human-authorized by Chris. Canonical domain authority has been formally transferred from legacy monolithic documents to the 18 focused domain specifications across `01_Domains/`, `02_Data_and_Security/`, `03_Integrations/`, and `04_Infrastructure/`. Legacy monolithic architecture documents have been safely narrowed to subordinate compatibility and technical-reference roles with unmistakable banners and supersession notices for conflicting legacy release text. Following initial transfer, independent review identified additional semantic coverage gaps (configuration layering, performance/telemetry truthfulness, emergency action controls, and factory-registry non-whitelist semantics), which were restored to their focused canonical owners (`storage-and-assets.md`, `performance-and-capacity.md`, `tool-permissions-and-actions.md`, and `runtime-and-models.md`) to ensure zero unique approved normative requirements were dropped. Authority transfer applied; independent review pending. Passes R12 (Roadmap & release sequencing reconciliation) and R13 (Archival, global routing, and documentation map closure) remain separate future passes.
