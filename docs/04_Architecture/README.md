...
| [`02_Data_and_Security/tool-permissions-and-actions.md`](02_Data_and_Security/tool-permissions-and-actions.md) | DEFAULT DENY, deterministic policy, emergency cancellation controls, generic shell rejection | [`SECURITY_AND_TRUST_ARCHITECTURE.md`](SECURITY_AND_TRUST_ARCHITECTURE.md) | Subordinate security / trust reference. |
...
| [`04_Infrastructure/storage-and-assets.md`](04_Infrastructure/storage-and-assets.md) | Persistent storage, configuration layering, and asset boundaries | [`AI_COMPANION_RUNTIME_CONFIGURATION_AND_ASSET_ARCHITECTURE.md`](AI_COMPANION_RUNTIME_CONFIGURATION_AND_ASSET_ARCHITECTURE.md) | Subordinate Phase 8P technical reference. |
