...
| [`tool-permissions-and-actions.md`](02_Data_and_Security/tool-permissions-and-actions.md) | DEFAULT DENY, deterministic policy, emergency cancellation controls, and generic shell rejection. | Decision D9, Principle P1 | [`SECURITY_AND_TRUST_ARCHITECTURE.md`](SECURITY_AND_TRUST_ARCHITECTURE.md) |
...
| [`storage-and-assets.md`](04_Infrastructure/storage-and-assets.md) | Persistent storage, configuration layering, asset boundaries, and Phase 8P storage layout. | Phase 8P Execution Baseline | [`AI_COMPANION_RUNTIME_CONFIGURATION_AND_ASSET_ARCHITECTURE.md`](AI_COMPANION_RUNTIME_CONFIGURATION_AND_ASSET_ARCHITECTURE.md) |
